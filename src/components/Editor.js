...
export function getEditorTemplate() {
    ...
    <div id="editor-modal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="dialog-content max-w-2xl h-[80vh] flex flex-col">
            <div class="flex items-center gap-2 border-b pb-4 px-8 pt-8">
            ...
            <div class="flex-1 py-6 overflow-y-auto px-8">
            ...
            <div class="border-t py-6 px-8 flex items-center justify-between gap-2 editor-bottom-bar shrink-0">
