(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function o(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function t(i){if(i.ep)return;i.ep=!0;const a=o(i);fetch(i.href,a)}})();class N{static async hashPassword(e){const t=new TextEncoder().encode(e+"salt_cloud_notes_2026"),i=await crypto.subtle.digest("SHA-512",t);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}static async deriveKey(e,o){const t=new TextEncoder,i=await crypto.subtle.importKey("raw",t.encode(e),{name:"PBKDF2"},!1,["deriveKey"]);return await crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(o),iterations:25e4,hash:"SHA-512"},i,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}static async encrypt(e,o){try{const t=crypto.getRandomValues(new Uint8Array(16)),i=crypto.getRandomValues(new Uint8Array(12)),a=await this.deriveKey(o,this.bufToHex(t)),r=new TextEncoder,s=await crypto.subtle.encrypt({name:"AES-GCM",iv:i},a,r.encode(typeof e=="string"?e:JSON.stringify(e)));return{payload:this.bufToHex(new Uint8Array(s)),iv:this.bufToHex(i),salt:this.bufToHex(t)}}catch(t){throw console.error("Encryption failed",t),t}}static async decrypt(e,o){try{const{payload:t,iv:i,salt:a}=e,r=await this.deriveKey(o,a),s=await crypto.subtle.decrypt({name:"AES-GCM",iv:this.hexToBuf(i)},r,this.hexToBuf(t)),d=new TextDecoder().decode(s);try{return JSON.parse(d)}catch{return d}}catch(t){throw console.error("Decryption failed. Wrong password?",t),t}}static bufToHex(e){return Array.from(new Uint8Array(e)).map(o=>o.toString(16).padStart(2,"0")).join("")}static hexToBuf(e){return new Uint8Array(e.match(/.{1,2}/g).map(o=>parseInt(o,16)))}}const u={notes:[],categories:[],settings:{theme:"dark",drivePath:"/backup/notes/",algo:"aes-256-gcm"},currentView:"all",editingNoteId:null,unlockedNotes:new Set,unlockedCategories:new Set,gapiLoaded:!1,tokenClient:null};async function X(){const n=sessionStorage.getItem("cn_pass_plain_v3");if(n){const e=await N.encrypt(u.notes,n),o=await N.encrypt(u.categories,n);localStorage.setItem("cn_notes_v3_enc",JSON.stringify(e)),localStorage.setItem("cn_categories_v3_enc",JSON.stringify(o)),localStorage.removeItem("cn_notes_v3"),localStorage.removeItem("cn_categories_v3")}localStorage.setItem("cn_settings_v3",JSON.stringify(u.settings))}async function Kt(n){try{const e=localStorage.getItem("cn_notes_v3_enc"),o=localStorage.getItem("cn_categories_v3_enc");if(e)u.notes=await N.decrypt(JSON.parse(e),n);else{const t=localStorage.getItem("cn_notes_v3");t&&(u.notes=JSON.parse(t))}if(o)u.categories=await N.decrypt(JSON.parse(o),n);else{const t=localStorage.getItem("cn_categories_v3");t&&(u.categories=JSON.parse(t))}}catch(e){throw console.error("Failed to load encrypted data",e),e}}function In(){const n=localStorage.getItem("cn_settings_v3");n&&(u.settings={...u.settings,...JSON.parse(n)})}const kn="v3.6.6",Re=[{id:"default",light:"#ffffff",dark:"#09090b"},{id:"red",light:"#fef2f2",dark:"#450a0a"},{id:"orange",light:"#fff7ed",dark:"#431407"},{id:"yellow",light:"#fefce8",dark:"#422006"},{id:"green",light:"#f0fdf4",dark:"#064e3b"},{id:"teal",light:"#f0fdfa",dark:"#134e4a"},{id:"blue",light:"#eff6ff",dark:"#1e3a8a"},{id:"darkblue",light:"#eef2ff",dark:"#1e1b4b"},{id:"purple",light:"#faf5ff",dark:"#3b0764"},{id:"pink",light:"#fdf2f8",dark:"#500724"},{id:"brown",light:"#fffaf5",dark:"#2d1a10"},{id:"gray",light:"#f8fafc",dark:"#0f172a"}],Zt=["#ffffff","#f28b82","#fbbc04","#fff475","#ccff90","#a7ffeb","#cbf0f8","#aecbfa","#d7aefb","#fdcfe8","#e6c9a8","#e8eaed","#1e293b","#450a0a","#422006","#064e3b","#134e4a","#1e3a8a","#1e1b4b","#4c1d95","#500724","#27272a","#09090b","#000000"],_n=["😊","😂","🥰","😎","🤔","😴","🔥","✨","🚀","🎉","❤️","👍","💡","📅","✅","❌","🔒","🔑","📌","🎨","📁","🏠","🌟","🌍","💻","📱","🍎","🍕","🍺","🌈","☀️","🌙","⚡","💎","🎁","🎈","🎵","📷","🔍","🛸","👾","🤖","👻","🦄","🐾","🏀","⚽","🚗","✈️","🕹️","🎮","🎲","🧩","🎭","🎬","🎤","🎧","🎹","🎸","🎻","🎺","🎷","🥁","🏹","🎣","🚵","🧗","🧘","🛁","🛌","🗝️","🛡️","⚔️","🗺️","🕯️","⌛","⚖️","⚙️","⚒️","🛠️","⛏️","⛓️","🔭","🔬","💊","💉","🧬","🩸","🧪","🌡️","🧴","🧹","🧺","🧼","🧽","🪣","🪒","🧻","🛀","🚿","🚽"];function S(n,e=3e3){const o=document.getElementById("toast");o&&(o.querySelector("div").innerText=n,o.classList.add("show"),setTimeout(()=>o.classList.remove("show"),e))}function te(n,e,o=!0){return new Promise(t=>{const i=document.getElementById("prompt-modal"),a=document.getElementById("prompt-input");if(!i||!a)return t(null);document.getElementById("prompt-title").innerText=n,document.getElementById("prompt-desc").innerText=e,a.type=o?"password":"text",a.value="",i.classList.remove("hidden"),q(),a.focus();const r=()=>{i.classList.add("hidden"),window.removeEventListener("keydown",s)},s=f=>{f.key==="Enter"&&l(),f.key==="Escape"&&d()};window.addEventListener("keydown",s);const l=()=>{const f=a.value;r(),t(f)},d=()=>{r(),t(null)};document.getElementById("prompt-confirm").onclick=l,document.getElementById("prompt-cancel").onclick=d})}function Cn(n){if(!n)return!0;const e=n.replace("#",""),o=parseInt(e.substr(0,2),16),t=parseInt(e.substr(2,2),16),i=parseInt(e.substr(4,2),16);return isNaN(o)||isNaN(t)||isNaN(i)?!0:(o*299+t*587+i*114)/1e3<128}function q(){typeof lucide<"u"&&lucide.createIcons&&lucide.createIcons()}class Qt{constructor(e="chunk_",o="/backup/notes/"){this.basePath=o,this.dbPrefix=e,this.chunkSizeLimit=100*1024}async getOrCreateFolder(e){const o=e.split("/").filter(i=>i);let t="root";for(const i of o){const a=`name = '${i}' and mimeType = 'application/vnd.google-apps.folder' and '${t}' in parents and trashed = false`,s=(await gapi.client.drive.files.list({q:a,fields:"files(id, name)"})).result.files;if(s.length>0)t=s[0].id;else{const l={name:i,mimeType:"application/vnd.google-apps.folder",parents:[t]};t=(await gapi.client.drive.files.create({resource:l,fields:"id"})).result.id}}return t}async saveChunks(e,o){const t=JSON.stringify(e),i=[];for(let a=0;a<t.length;a+=this.chunkSizeLimit)i.push(t.substring(a,a+this.chunkSizeLimit));for(let a=0;a<i.length;a++){const r=`${this.dbPrefix}${a}.json`;await this.uploadFile(r,i[a],o)}return i.length}async uploadFile(e,o,t){const i=`name = '${e}' and '${t}' in parents and trashed = false`,r=(await gapi.client.drive.files.list({q:i,fields:"files(id)"})).result.files,s=r.length>0?r[0].id:null,l={name:e,parents:s?[]:[t]},d=new Blob([o],{type:"application/json"}),f=gapi.auth.getToken().access_token,c=s?"PATCH":"POST",v=s?`https://www.googleapis.com/upload/drive/v3/files/${s}?uploadType=media`:"https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart";if(s)await fetch(v,{method:c,headers:{Authorization:`Bearer ${f}`},body:d});else{const p=new FormData;p.append("metadata",new Blob([JSON.stringify(l)],{type:"application/json"})),p.append("file",d),await fetch(v,{method:c,headers:{Authorization:`Bearer ${f}`},body:p})}}async loadChunks(e){const o=`name contains '${this.dbPrefix}' and '${e}' in parents and trashed = false`,i=(await gapi.client.drive.files.list({q:o,fields:"files(id, name)",orderBy:"name"})).result.files;let a="";for(const r of i){const s=await gapi.client.drive.files.get({fileId:r.id,alt:"media"});a+=typeof s.result=="string"?s.result:JSON.stringify(s.result)}return a?JSON.parse(a):null}}function Tn(){return`
    ...
    <div id="toast">
        <div class="border">
            ...
            `,m};if(o&&o.appendChild(v(!1)),t&&t.appendChild(v(!0)),i){const p=document.createElement("option");p.value=c.id,p.innerText=c.name,i.appendChild(p)}d(c.id,c.name,c.color)}),q()}/**!
 * Sortable 1.15.6
 * @author	RubaXa   <trash@rubaxa.org>
 * @author	owenm    <owen23355@gmail.com>
 * @license MIT
 */function Mt(n,e){var o=Object.keys(n);if(Object.getOwnPropertySymbols){var t=Object.getOwnPropertySymbols(n);e&&(t=t.filter(function(i){return Object.getOwnPropertyDescriptor(n,i).enumerable})),o.push.apply(o,t)}return o}function K(n){for(var e=1;e<arguments.length;e++){var o=arguments[e]!=null?arguments[e]:{};e%2?Mt(Object(o),!0).forEach(function(t){Rn(n,t,o[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(o)):Mt(Object(o)).forEach(function(t){Object.defineProperty(n,t,Object.getOwnPropertyDescriptor(o,t))})}return n}function et(n){"@babel/helpers - typeof";return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?et=function(e){return typeof e}:et=function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},et(n)}function Rn(n,e,o){return e in n?Object.defineProperty(n,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):n[e]=o,n}function ne(){return ne=Object.assign||function(n){for(var e=1;e<arguments.length;e++){var o=arguments[e];for(var t in o)Object.prototype.hasOwnProperty.call(o,t)&&(n[t]=o[t])}return n},ne.apply(this,arguments)}function Gn(n,e){if(n==null)return{};var o={},t=Object.keys(n),i,a;for(a=0;a<t.length;a++)i=t[a],!(e.indexOf(i)>=0)&&(o[i]=n[i]);return o}function Xn(n,e){if(n==null)return{};var o=Gn(n,e),t,i;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(n);for(i=0;i<a.length;i++)t=a[i],!(e.indexOf(t)>=0)&&Object.prototype.propertyIsEnumerable.call(n,t)&&(o[t]=n[t])}return o}var Yn="1.15.6";function Q(n){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(n)}var oe=Q(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),Xe=Q(/Edge/i),Ht=Q(/firefox/i),He=Q(/safari/i)&&!Q(/chrome/i)&&!Q(/android/i),Tt=Q(/iP(ad|od|hone)/i),an=Q(/chrome/i)&&Q(/android/i),rn={capture:!1,passive:!1};function E(n,e,o){n.addEventListener(e,o,!oe&&rn)}function x(n,e,o){n.removeEventListener(e,o,!oe&&rn)}function at(n,e){if(e){if(e[0]===">"&&(e=e.substring(1)),n)try{if(n.matches)return n.matches(e);if(n.msMatchesSelector)return n.msMatchesSelector(e);if(n.webkitMatchesSelector)return n.webkitMatchesSelector(e)}catch{return!1}return!1}}function sn(n){return n.host&&n!==document&&n.host.nodeType?n.host:n.parentNode}function U(n,e,o,t){if(n){o=o||document;do{if(e!=null&&(e[0]===">"?n.parentNode===o&&at(n,e):at(n,e))||t&&n===o)return n;if(n===o)break}while(n=sn(n))}return null}var jt=/\s+/g;function $(n,e,o){if(n&&e)if(n.classList)n.classList[o?"add":"remove"](e);else{var t=(" "+n.className+" ").replace(jt," ").replace(" "+e+" "," ");n.className=(t+(o?" "+e:"")).replace(jt," ")}}function b(n,e,o){var t=n&&n.style;if(t){if(o===void 0)return document.defaultView&&document.defaultView.getComputedStyle?o=document.defaultView.getComputedStyle(n,""):n.currentStyle&&(o=n.currentStyle),e===void 0?o:o[e];!(e in t)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),t[e]=o+(typeof o=="string"?"":"px")}}function Ee(n,e){var o="";if(typeof n=="string")o=n;else do{var t=b(n,"transform");t&&t!=="none"&&(o=t+" "+o)}while(!e&&(n=n.parentNode));var i=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return i&&new i(o)}function ln(n,e,o){if(n){var t=n.getElementsByTagName(e),i=0,a=t.length;if(o)for(;i<a;i++)o(t[i],i);return t}return[]}function J(){var n=document.scrollingElement;return n||document.documentElement}function L(n,e,o,t,i){if(!(!n.getBoundingClientRect&&n!==window)){var a,r,s,l,d,f,c;if(n!==window&&n.parentNode&&n!==J()?(a=n.getBoundingClientRect(),r=a.top,s=a.left,l=a.bottom,d=a.right,f=a.height,c=a.width):(r=0,s=0,l=window.innerHeight,d=window.innerWidth,f=window.innerHeight,c=window.innerWidth),(e||o)&&n!==window&&(i=i||n.parentNode,!oe))do if(i&&i.getBoundingClientRect&&(b(i,"transform")!=="none"||o&&b(i,"position")!=="static")){var v=i.getBoundingClientRect();r-=v.top+parseInt(b(i,"border-top-width")),s-=v.left+parseInt(b(i,"border-left-width")),l=r+a.height,d=s+a.width;break}while(i=i.parentNode);if(t&&n!==window){var p=Ee(i||n),m=p&&p.a,h=p&&p.d;p&&(r/=h,s/=m,c/=m,f/=h,l=r+f,d=s+c)}return{top:r,left:s,bottom:l,right:d,width:c,height:f}}}function qt(n,e,o){for(var t=le(n,!0),i=L(n)[e];t;){var a=L(t)[o],r=void 0;if(r=i>=a,!r)return t;if(t===J())break;t=le(t,!1)}return!1}function Se(n,e,o,t){for(var i=0,a=0,r=n.children;a<r.length;){if(r[a].style.display!=="none"&&r[a]!==y.ghost&&(t||r[a]!==y.dragged)&&U(r[a],o.draggable,n,!1)){if(i===e)return r[a];i++}a++}return null}function Dt(n,e){for(var o=n.lastElementChild;o&&(o===y.ghost||b(o,"display")==="none"||e&&!at(o,e));)o=o.previousElementSibling;return o||null}function G(n,e){var o=0;if(!n||!n.parentNode)return-1;for(;n=n.previousElementSibling;)n.nodeName.toUpperCase()!=="TEMPLATE"&&n!==y.clone&&(!e||at(n,e))&&o++;return o}function zt(n){var e=0,o=0,t=J();if(n)do{var i=Ee(n),a=i.a,r=i.d;e+=n.scrollLeft*a,o+=n.scrollTop*r}while(n!==t&&(n=n.parentNode));return[e,o]}function Wn(n,e){for(var o in n)if(n.hasOwnProperty(o)){for(var t in e)if(e.hasOwnProperty(t)&&e[t]===n[o][t])return Number(o)}return-1}function le(n,e){if(!n||!n.getBoundingClientRect)return J();var o=n,t=!1;do if(o.clientWidth<o.scrollWidth||o.clientHeight<o.scrollHeight){var i=b(o);if(o.clientWidth<o.scrollWidth&&(i.overflowX=="auto"||i.overflowX=="scroll")||o.clientHeight<o.scrollHeight&&(i.overflowY=="auto"||i.overflowY=="scroll")){if(!o.getBoundingClientRect||o===document.body)return J();if(t||e)return o;t=!0}}while(o=o.parentNode);return J()}function Un(n,e){if(n&&e)for(var o in e)e.hasOwnProperty(o)&&(n[o]=e[o]);return n}function ft(n,e){return Math.round(n.top)===Math.round(e.top)&&Math.round(n.left)===Math.round(e.left)&&Math.round(n.height)===Math.round(e.height)&&Math.round(n.width)===Math.round(e.width)}var je;function dn(n,e){return function(){if(!je){var o=arguments,t=this;o.length===1?n.call(t,o[0]):n.apply(t,o),je=setTimeout(function(){je=void 0},e)}}}function Vn(){clearTimeout(je),je=void 0}function cn(n,e,o){n.scrollLeft+=e,n.scrollTop+=o}function un(n){var e=window.Polymer,o=window.jQuery||window.Zepto;return e&&e.dom?e.dom(n).cloneNode(!0):o?o(n).clone(!0)[0]:n.cloneNode(!0)}function fn(n,e,o){var t={};return Array.from(n.children).forEach(function(i){var a,r,s,l;if(!(!U(i,e.draggable,n,!1)||i.animated||i===o)){var d=L(i);t.left=Math.min((a=t.left)!==null&&a!==void 0?a:1/0,d.left),t.top=Math.min((r=t.top)!==null&&r!==void 0?r:1/0,d.top),t.right=Math.max((s=t.right)!==null&&s!==void 0?s:-1/0,d.right),t.bottom=Math.max((l=t.bottom)!==null&&l!==void 0?l:-1/0,d.bottom)}}),t.width=t.right-t.left,t.height=t.bottom-t.top,t.x=t.left,t.y=t.top,t}var j="Sortable"+new Date().getTime();function Jn(){var n=[],e;return{captureAnimationState:function(){if(n=[],!!this.options.animation){var t=[].slice.call(this.el.children);t.forEach(function(i){if(!(b(i,"display")==="none"||i===y.ghost)){n.push({target:i,rect:L(i)});var a=K({},n[n.length-1].rect);if(i.thisAnimationDuration){var r=Ee(i,!0);r&&(a.top-=r.f,a.left-=r.e)}i.fromRect=a}})}},addAnimationState:function(t){n.push(t)},removeAnimationState:function(t){n.splice(Wn(n,{target:t}),1)},animateAll:function(t){var i=this;if(!this.options.animation){clearTimeout(e),typeof t=="function"&&t();return}var a=!1,r=0;n.forEach(function(s){var l=0,d=s.target,f=d.fromRect,c=L(d),v=d.prevFromRect,p=d.prevToRect,m=s.rect,h=Ee(d,!0);h&&(c.top-=h.f,c.left-=h.e),d.toRect=c,d.thisAnimationDuration&&ft(v,c)&&!ft(f,c)&&(m.top-c.top)/(m.left-c.left)===(f.top-c.top)/(f.left-c.left)&&(l=Zn(m,v,p,i.options)),ft(c,f)||(d.prevFromRect=f,d.prevToRect=c,l||(l=i.options.animation),i.animate(d,m,c,l)),l&&(a=!0,r=Math.max(r,l),clearTimeout(d.animationResetTimer),d.animationResetTimer=setTimeout(function(){d.animationTime=0,d.prevFromRect=null,d.fromRect=null,d.prevToRect=null,d.thisAnimationDuration=null},l),d.thisAnimationDuration=l)}),clearTimeout(e),a?e=setTimeout(function(){typeof t=="function"&&t()},r):typeof t=="function"&&t(),n=[]},animate:function(t,i,a,r){if(r){b(t,"transition",""),b(t,"transform","");var s=Ee(this.el),l=s&&s.a,d=s&&s.d,f=(i.left-a.left)/(l||1),c=(i.top-a.top)/(d||1);t.animatingX=!!f,t.animatingY=!!c,b(t,"transform","translate3d("+f+"px,"+c+"px,0)"),this.forRepaintDummy=Kn(t),b(t,"transition","transform "+r+"ms"+(this.options.easing?" "+this.options.easing:"")),b(t,"transform","translate3d(0,0,0)"),typeof t.animated=="number"&&clearTimeout(t.animated),t.animated=setTimeout(function(){b(t,"transition",""),b(t,"transform",""),t.animated=!1,t.animatingX=!1,t.animatingY=!1},r)}}}}function Kn(n){return n.offsetWidth}function Zn(n,e,o,t){return Math.sqrt(Math.pow(e.top-n.top,2)+Math.pow(e.left-n.left,2))/Math.sqrt(Math.pow(e.top-o.top,2)+Math.pow(e.left-o.left,2))*t.animation}var he=[],pt={initializeByDefault:!0},Ye={mount:function(e){for(var o in pt)pt.hasOwnProperty(o)&&!(o in e)&&(e[o]=pt[o]);he.forEach(function(t){if(t.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),he.push(e)},pluginEvent:function(e,o,t){var i=this;this.eventCanceled=!1,t.cancel=function(){i.eventCanceled=!0};var a=e+"Global";he.forEach(function(r){o[r.pluginName]&&(o[r.pluginName][a]&&o[r.pluginName][a](K({sortable:o},t)),o.options[r.pluginName]&&o[r.pluginName][e]&&o[r.pluginName][e](K({sortable:o},t)))})},initializePlugins:function(e,o,t,i){he.forEach(function(s){var l=s.pluginName;if(!(!e.options[l]&&!s.initializeByDefault)){var d=new s(e,o,e.options);d.sortable=e,d.options=e.options,e[l]=d,ne(t,d.defaults)}});for(var a in e.options)if(e.options.hasOwnProperty(a)){var r=this.modifyOption(e,a,e.options[a]);typeof r<"u"&&(e.options[a]=r)}},getEventProperties:function(e,o){var t={};return he.forEach(function(i){typeof i.eventProperties=="function"&&ne(t,i.eventProperties.call(o[i.pluginName],e))}),t},modifyOption:function(e,o,t){var i;return he.forEach(function(a){e[a.pluginName]&&a.optionListeners&&typeof a.optionListeners[o]=="function"&&(i=a.optionListeners[o].call(e[a.pluginName],t))}),i}};function Qn(n){var e=n.sortable,o=n.rootEl,t=n.name,i=n.targetEl,a=n.cloneEl,r=n.toEl,s=n.fromEl,l=n.oldIndex,d=n.newIndex,f=n.oldDraggableIndex,c=n.newDraggableIndex,v=n.originalEvent,p=n.putSortable,m=n.extraEventProperties;if(e=e||o&&o[j],!!e){var h,k=e.options,T="on"+t.charAt(0).toUpperCase()+t.substr(1);window.CustomEvent&&!oe&&!Xe?h=new CustomEvent(t,{bubbles:!0,cancelable:!0}):(h=document.createEvent("Event"),h.initEvent(t,!0,!0)),h.to=r||o,h.from=s||o,h.item=i||o,h.clone=a,h.oldIndex=l,h.newIndex=d,h.oldDraggableIndex=f,h.newDraggableIndex=c,h.originalEvent=v,h.pullMode=p?p.lastPutMode:void 0;var O=K(K({},m),Ye.getEventProperties(t,e));for(var Y in O)h[Y]=O[Y];o&&o.dispatchEvent(h),k[T]&&k[T].call(e,h)}}var eo=["evt"],H=function(e,o){var t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},i=t.evt,a=Xn(t,eo);Ye.pluginEvent.bind(y)(e,o,K({dragEl:g,parentEl:D,ghostEl:w,rootEl:_,nextEl:ge,lastDownEl:tt,cloneEl:C,cloneHidden:se,dragStarted:Ae,putSortable:A,activeSortable:y.active,originalEvent:i,oldIndex:xe,oldDraggableIndex:qe,newIndex:R,newDraggableIndex:re,hideGhostForTarget:hn,unhideGhostForTarget:vn,cloneNowHidden:function(){se=!0},cloneNowShown:function(){se=!1},dispatchSortableEvent:function(s){M({sortable:o,name:s,originalEvent:i})}},a))};function M(n){Qn(K({putSortable:A,cloneEl:C,targetEl:g,rootEl:_,oldIndex:xe,oldDraggableIndex:qe,newIndex:R,newDraggableIndex:re},n))}var g,D,w,_,ge,tt,C,se,xe,R,qe,re,Ve,A,be=!1,rt=!1,st=[],fe,W,gt,mt,Ft,$t,Ae,ve,ze,Fe=!1,Je=!1,nt,P,ht=[],It=!1,lt=[],ut=typeof document<"u",Ke=Tt,Rt=Xe||oe?"cssFloat":"float",to=ut&&!an&&!Tt&&"draggable"in document.createElement("div"),pn=function(){if(ut){if(oe)return!1;var n=document.createElement("x");return n.style.cssText="pointer-events:auto",n.style.pointerEvents==="auto"}}(),gn=function(e,o){var t=b(e),i=parseInt(t.width)-parseInt(t.paddingLeft)-parseInt(t.paddingRight)-parseInt(t.borderLeftWidth)-parseInt(t.borderRightWidth),a=Se(e,0,o),r=Se(e,1,o),s=a&&b(a),l=r&&b(r),d=s&&parseInt(s.marginLeft)+parseInt(s.marginRight)+L(a).width,f=l&&parseInt(l.marginLeft)+parseInt(l.marginRight)+L(r).width;if(t.display==="flex")return t.flexDirection==="column"||t.flexDirection==="column-reverse"?"vertical":"horizontal";if(t.display==="grid")return t.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(a&&s.float&&s.float!=="none"){var c=s.float==="left"?"left":"right";return r&&(l.clear==="both"||l.clear===c)?"vertical":"horizontal"}return a&&(s.display==="block"||s.display==="flex"||s.display==="table"||s.display==="grid"||d>=i&&t[Rt]==="none"||r&&t[Rt]==="none"&&d+f>i)?"vertical":"horizontal"},no=function(e,o,t){var i=t?e.left:e.top,a=t?e.right:e.bottom,r=t?e.width:e.height,s=t?o.left:o.top,l=t?o.right:o.bottom,d=t?o.width:o.height;return i===s||a===l||i+r/2===s+d/2},oo=function(e,o){var t;return st.some(function(i){var a=i[j].options.emptyInsertThreshold;if(!(!a||Dt(i))){var r=L(i),s=e>=r.left-a&&e<=r.right+a,l=o>=r.top-a&&o<=r.bottom+a;if(s&&l)return t=i}}),t},mn=function(e){function o(a,r){return function(s,l,d,f){var c=s.options.group.name&&l.options.group.name&&s.options.group.name===l.options.group.name;if(a==null&&(r||c))return!0;if(a==null||a===!1)return!1;if(r&&a==="clone")return a;if(typeof a=="function")return o(a(s,l,d,f),r)(s,l,d,f);var v=(r?s:l).options.group.name;return a===!0||typeof a=="string"&&a===v||a.join&&a.indexOf(v)>-1}}var t={},i=e.group;(!i||et(i)!="object")&&(i={name:i}),t.name=i.name,t.checkPull=o(i.pull,!0),t.checkPut=o(i.put),t.revertClone=i.revertClone,e.group=t},hn=function(){!pn&&w&&b(w,"display","none")},vn=function(){!pn&&w&&b(w,"display","")};ut&&!an&&document.addEventListener("click",function(n){if(rt)return n.preventDefault(),n.stopPropagation&&n.stopPropagation(),n.stopImmediatePropagation&&n.stopImmediatePropagation(),rt=!1,!1},!0);var pe=function(e){if(g){e=e.touches?e.touches[0]:e;var o=oo(e.clientX,e.clientY);if(o){var t={};for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);t.target=t.rootEl=o,t.preventDefault=void 0,t.stopPropagation=void 0,o[j]._onDragOver(t)}}},io=function(e){g&&g.parentNode[j]._isOutsideThisEl(e.target)};function y(n,e){if(!(n&&n.nodeType&&n.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(n));this.el=n,this.options=e=ne({},e),n[j]=this;var o={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(n.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return gn(n,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(r,s){r.setData("Text",s.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:y.supportPointer!==!1&&"PointerEvent"in window&&(!He||Tt),emptyInsertThreshold:5};Ye.initializePlugins(this,n,o);for(var t in o)!(t in e)&&(e[t]=o[t]);mn(e);for(var i in this)i.charAt(0)==="_"&&typeof this[i]=="function"&&(this[i]=this[i].bind(this));this.nativeDraggable=e.forceFallback?!1:to,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?E(n,"pointerdown",this._onTapStart):(E(n,"mousedown",this._onTapStart),E(n,"touchstart",this._onTapStart)),this.nativeDraggable&&(E(n,"dragover",this),E(n,"dragenter",this)),st.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),ne(this,Jn())}y.prototype={constructor:y,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(ve=null)},_getDirection:function(e,o){return typeof this.options.direction=="function"?this.options.direction.call(this,e,o,g):this.options.direction},_onTapStart:function(e){if(e.cancelable){var o=this,t=this.el,i=this.options,a=i.preventOnFilter,r=e.type,s=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,l=(s||e).target,d=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||l,f=i.filter;if(po(t),!g&&!(/mousedown|pointerdown/.test(r)&&e.button!==0||i.disabled)&&!d.isContentEditable&&!(!this.nativeDraggable&&He&&l&&l.tagName.toUpperCase()==="SELECT")&&(l=U(l,i.draggable,t,!1),!(l&&l.animated)&&tt!==l)){if(xe=G(l),qe=G(l,i.draggable),typeof f=="function"){if(f.call(this,e,l,this)){M({sortable:o,rootEl:d,name:"filter",targetEl:l,toEl:t,fromEl:t}),H("filter",o,{evt:e}),a&&e.preventDefault();return}}else if(f&&(f=f.split(",").some(function(c){if(c=U(d,c.trim(),t,!1),c)return M({sortable:o,rootEl:c,name:"filter",targetEl:l,fromEl:t,toEl:t}),H("filter",o,{evt:e}),!0}),f)){a&&e.preventDefault();return}i.handle&&!U(d,i.handle,t,!1)||this._prepareDragStart(e,s,l)}}},_prepareDragStart:function(e,o,t){var i=this,a=i.el,r=i.options,s=a.ownerDocument,l;if(t&&!g&&t.parentNode===a){var d=L(t);if(_=a,g=t,D=g.parentNode,ge=g.nextSibling,tt=t,Ve=r.group,y.dragged=g,fe={target:g,clientX:(o||e).clientX,clientY:(o||e).clientY},Ft=fe.clientX-d.left,$t=fe.clientY-d.top,this._lastX=(o||e).clientX,this._lastY=(o||e).clientY,g.style["will-change"]="all",l=function(){if(H("delayEnded",i,{evt:e}),y.eventCanceled){i._onDrop();return}i._disableDelayedDragEvents(),!Ht&&i.nativeDraggable&&(g.draggable=!0),i._triggerDragStart(e,o),M({sortable:i,name:"choose",originalEvent:e}),$(g,r.chosenClass,!0)},r.ignore.split(",").forEach(function(f){ln(g,f.trim(),vt)}),E(s,"dragover",pe),E(s,"mousemove",pe),E(s,"touchmove",pe),r.supportPointer?(E(s,"pointerup",i._onDrop),!this.nativeDraggable&&E(s,"pointercancel",i._onDrop)):(E(s,"mouseup",i._onDrop),E(s,"touchend",i._onDrop),E(s,"touchcancel",i._onDrop)),Ht&&this.nativeDraggable&&(this.options.touchStartThreshold=4,g.draggable=!0),H("delayStart",this,{evt:e}),r.delay&&(!r.delayOnTouchOnly||o)&&(!this.nativeDraggable||!(Xe||oe))){if(y.eventCanceled){this._onDrop();return}r.supportPointer?(E(s,"pointerup",i._disableDelayedDrag),E(s,"pointercancel",i._disableDelayedDrag)):(E(s,"mouseup",i._disableDelayedDrag),E(s,"touchend",i._disableDelayedDrag),E(s,"touchcancel",i._disableDelayedDrag)),E(s,"mousemove",i._delayedDragTouchMoveHandler),E(s,"touchmove",i._delayedDragTouchMoveHandler),r.supportPointer&&E(s,"pointermove",i._delayedDragTouchMoveHandler),i._dragStartTimer=setTimeout(l,r.delay)}else l()}},_delayedDragTouchMoveHandler:function(e){var o=e.touches?e.touches[0]:e;Math.max(Math.abs(o.clientX-this._lastX),Math.abs(o.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){g&&vt(g),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;x(e,"mouseup",this._disableDelayedDrag),x(e,"touchend",this._disableDelayedDrag),x(e,"touchcancel",this._disableDelayedDrag),x(e,"pointerup",this._disableDelayedDrag),x(e,"pointercancel",this._disableDelayedDrag),x(e,"mousemove",this._delayedDragTouchMoveHandler),x(e,"touchmove",this._delayedDragTouchMoveHandler),x(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,o){o=o||e.pointerType=="touch"&&e,!this.nativeDraggable||o?this.options.supportPointer?E(document,"pointermove",this._onTouchMove):o?E(document,"touchmove",this._onTouchMove):E(document,"mousemove",this._onTouchMove):(E(g,"dragend",this),E(_,"dragstart",this._onDragStart));try{document.selection?ot(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,o){if(be=!1,_&&g){H("dragStarted",this,{evt:o}),this.nativeDraggable&&E(document,"dragover",io);var t=this.options;!e&&$(g,t.dragClass,!1),$(g,t.ghostClass,!0),y.active=this,e&&this._appendGhost(),M({sortable:this,name:"start",originalEvent:o})}else this._nulling()},_emulateDragOver:function(){if(W){this._lastX=W.clientX,this._lastY=W.clientY,hn();for(var e=document.elementFromPoint(W.clientX,W.clientY),o=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(W.clientX,W.clientY),e!==o);)o=e;if(g.parentNode[j]._isOutsideThisEl(e),o)do{if(o[j]){var t=void 0;if(t=o[j]._onDragOver({clientX:W.clientX,clientY:W.clientY,target:e,rootEl:o}),t&&!this.options.dragoverBubble)break}e=o}while(o=sn(o));vn()}},_onTouchMove:function(e){if(fe){var o=this.options,t=o.fallbackTolerance,i=o.fallbackOffset,a=e.touches?e.touches[0]:e,r=w&&Ee(w,!0),s=w&&r&&r.a,l=w&&r&&r.d,d=Ke&&P&&zt(P),f=(a.clientX-fe.clientX+i.x)/(s||1)+(d?d[0]-ht[0]:0)/(s||1),c=(a.clientY-fe.clientY+i.y)/(l||1)+(d?d[1]-ht[1]:0)/(l||1);if(!y.active&&!be){if(t&&Math.max(Math.abs(a.clientX-this._lastX),Math.abs(a.clientY-this._lastY))<t)return;this._onDragStart(e,!0)}if(w){r?(r.e+=f-(gt||0),r.f+=c-(mt||0)):r={a:1,b:0,c:0,d:1,e:f,f:c};var v="matrix(".concat(r.a,",").concat(r.b,",").concat(r.c,",").concat(r.d,",").concat(r.e,",").concat(r.f,")");b(w,"webkitTransform",v),b(w,"mozTransform",v),b(w,"msTransform",v),b(w,"transform",v),gt=f,mt=c,W=a}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!w){var e=this.options.fallbackOnBody?document.body:_,o=L(g,!0,Ke,!0,e),t=this.options;if(Ke){for(P=e;b(P,"position")==="static"&&b(P,"transform")==="none"&&P!==document;)P=P.parentNode;P!==document.body&&P!==document.documentElement?(P===document&&(P=J()),o.top+=P.scrollTop,o.left+=P.scrollLeft):P=J(),ht=zt(P)}w=g.cloneNode(!0),$(w,t.ghostClass,!1),$(w,t.fallbackClass,!0),$(w,t.dragClass,!0),b(w,"transition",""),b(w,"transform",""),b(w,"box-sizing","border-box"),b(w,"margin",0),b(w,"top",o.top),b(w,"left",o.left),b(w,"width",o.width),b(w,"height",o.height),b(w,"opacity","0.8"),b(w,"position",Ke?"absolute":"fixed"),b(w,"zIndex","100000"),b(w,"pointerEvents","none"),y.ghost=w,e.appendChild(w),b(w,"transform-origin",Ft/parseInt(w.style.width)*100+"% "+$t/parseInt(w.style.height)*100+"%")}},_onDragStart:function(e,o){var t=this,i=e.dataTransfer,a=t.options;if(H("dragStart",this,{evt:e}),y.eventCanceled){this._onDrop();return}H("setupClone",this),y.eventCanceled||(C=un(g),C.removeAttribute("id"),C.draggable=!1,C.style["will-change"]="",this._hideClone(),$(C,this.options.chosenClass,!1),y.clone=C),t.cloneId=ot(function(){H("clone",t),!y.eventCanceled&&(t.options.removeCloneOnHide||_.insertBefore(C,g),t._hideClone(),M({sortable:t,name:"clone"}))}),!o&&$(g,a.dragClass,!0),o?(rt=!0,t._loopId=setInterval(t._emulateDragOver,50)):(x(document,"mouseup",t._onDrop),x(document,"touchend",t._onDrop),x(document,"touchcancel",t._onDrop),i&&(i.effectAllowed="move",a.setData&&a.setData.call(t,i,g)),E(document,"drop",t),b(g,"transform","translateZ(0)")),be=!0,t._dragStartId=ot(t._dragStarted.bind(t,o,e)),E(document,"selectstart",t),Ae=!0,window.getSelection().removeAllRanges(),He&&b(document.body,"user-select","none")},_onDragOver:function(e){var o=this.el,t=e.target,i,a,r,s=this.options,l=s.group,d=y.active,f=Ve===l,c=s.sort,v=A||d,p,m=this,h=!1;if(It)return;function k(Te,En){H(Te,m,K({evt:e,isOwner:f,axis:p?"vertical":"horizontal",revert:r,dragRect:i,targetRect:a,canSort:c,fromSortable:v,target:t,completed:O,onMove:function(Nt,Sn){return Ze(_,o,g,i,Nt,L(Nt),e,Sn)},changed:Y},En))}function T(){k("dragOverAnimationCapture"),m.captureAnimationState(),m!==v&&v.captureAnimationState()}function O(Te){return k("dragOverCompleted",{insertion:Te}),Te&&(f?d._hideClone():d._showClone(m),m!==v&&($(g,A?A.options.ghostClass:d.options.ghostClass,!1),$(g,s.ghostClass,!0)),A!==m&&m!==y.active?A=m:m===y.active&&A&&(A=null),v===m&&(m._ignoreWhileAnimating=t),m.animateAll(function(){k("dragOverAnimationComplete"),m._ignoreWhileAnimating=null}),m!==v&&(v.animateAll(),v._ignoreWhileAnimating=null)),(t===g&&!g.animated||t===o&&!t.animated)&&(ve=null),!s.dragoverBubble&&!e.rootEl&&t!==document&&(g.parentNode[j]._isOutsideThisEl(e.target),!Te&&pe(e)),!s.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),h=!0}function Y(){R=G(g),re=G(g,s.draggable),M({sortable:m,name:"change",toEl:o,newIndex:R,newDraggableIndex:re,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),t=U(t,s.draggable,o,!0),k("dragOver"),y.eventCanceled)return h;if(g.contains(e.target)||t.animated&&t.animatingX&&t.animatingY||m._ignoreWhileAnimating===t)return O(!1);if(rt=!1,d&&!s.disabled&&(f?c||(r=D!==_):A===this||(this.lastPutMode=Ve.checkPull(this,d,g,e))&&l.checkPut(this,d,g,e))){if(p=this._getDirection(e,t)==="vertical",i=L(g),k("dragOverValid"),y.eventCanceled)return h;if(r)return D=_,T(),this._hideClone(),k("revert"),y.eventCanceled||(ge?_.insertBefore(g,ge):_.appendChild(g)),O(!0);var z=Dt(o,s.draggable);if(!z||lo(e,p,this)&&!z.animated){if(z===g)return O(!1);if(z&&o===e.target&&(t=z),t&&(a=L(t)),Ze(_,o,g,i,t,a,e,!!t)!==!1)return T(),z&&z.nextSibling?o.insertBefore(g,z.nextSibling):o.appendChild(g),D=o,Y(),O(!0)}else if(z&&so(e,p,this)){var de=Se(o,0,s,!0);if(de===g)return O(!1);if(t=de,a=L(t),Ze(_,o,g,i,t,a,e,!1)!==!1)return T(),o.insertBefore(g,de),D=o,Y(),O(!0)}else if(t.parentNode===o){a=L(t);var V=0,ce,Ie=g.parentNode!==o,F=!no(g.animated&&g.toRect||i,t.animated&&t.toRect||a,p),ke=p?"top":"left",ie=qt(t,"top","top")||qt(g,"top","top"),_e=ie?ie.scrollTop:void 0;ve!==t&&(ce=a[ke],Fe=!1,Je=!F&&s.invertSwap||Ie),V=co(e,t,a,p,F?1:s.swapThreshold,s.invertedSwapThreshold==null?s.swapThreshold:s.invertedSwapThreshold,Je,ve===t);var Z;if(V!==0){var ue=G(g);do ue-=V,Z=D.children[ue];while(Z&&(b(Z,"display")==="none"||Z===w))}if(V===0||Z===t)return O(!1);ve=t,ze=V;var Ce=t.nextElementSibling,ae=!1;ae=V===1;var We=Ze(_,o,g,i,t,a,e,ae);if(We!==!1)return(We===1||We===-1)&&(ae=We===1),It=!0,setTimeout(ro,30),T(),ae&&!Ce?o.appendChild(g):t.parentNode.insertBefore(g,ae?Ce:t),ie&&cn(ie,0,_e-ie.scrollTop),D=g.parentNode,ce!==void 0&&!Je&&(nt=Math.abs(ce-L(t)[ke])),Y(),O(!0)}if(o.contains(g))return O(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){x(document,"mousemove",this._onTouchMove),x(document,"touchmove",this._onTouchMove),x(document,"pointermove",this._onTouchMove),x(document,"dragover",pe),x(document,"mousemove",pe),x(document,"touchmove",pe)},_offUpEvents:function(){var e=this.el.ownerDocument;x(e,"mouseup",this._onDrop),x(e,"touchend",this._onDrop),x(e,"pointerup",this._onDrop),x(e,"pointercancel",this._onDrop),x(e,"touchcancel",this._onDrop),x(document,"selectstart",this)},_onDrop:function(e){var o=this.el,t=this.options;if(R=G(g),re=G(g,t.draggable),H("drop",this,{evt:e}),D=g&&g.parentNode,R=G(g),re=G(g,t.draggable),y.eventCanceled){this._nulling();return}be=!1,Je=!1,Fe=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),kt(this.cloneId),kt(this._dragStartId),this.nativeDraggable&&(x(document,"drop",this),x(o,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),He&&b(document.body,"user-select",""),b(g,"transform",""),e&&(Ae&&(e.cancelable&&e.preventDefault(),!t.dropBubble&&e.stopPropagation()),w&&w.parentNode&&w.parentNode.removeChild(w),(_===D||A&&A.lastPutMode!=="clone")&&C&&C.parentNode&&C.parentNode.removeChild(C),g&&(this.nativeDraggable&&x(g,"dragend",this),vt(g),g.style["will-change"]="",Ae&&!be&&$(g,A?A.options.ghostClass:this.options.ghostClass,!1),$(g,this.options.chosenClass,!1),M({sortable:this,name:"unchoose",toEl:D,newIndex:null,newDraggableIndex:null,originalEvent:e}),_!==D?(R>=0&&(M({rootEl:D,name:"add",toEl:D,fromEl:_,originalEvent:e}),M({sortable:this,name:"remove",toEl:D,originalEvent:e}),M({rootEl:D,name:"sort",toEl:D,fromEl:_,originalEvent:e}),M({sortable:this,name:"sort",toEl:D,originalEvent:e})),A&&A.save()):R!==xe&&R>=0&&(M({sortable:this,name:"update",toEl:D,originalEvent:e}),M({sortable:this,name:"sort",toEl:D,originalEvent:e})),y.active&&((R==null||R===-1)&&(R=xe,re=qe),M({sortable:this,name:"end",toEl:D,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){H("nulling",this),_=g=D=w=ge=C=tt=se=fe=W=Ae=R=re=xe=qe=ve=ze=A=Ve=y.dragged=y.ghost=y.clone=y.active=null,lt.forEach(function(e){e.checked=!0}),lt.length=gt=mt=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":g&&(this._onDragOver(e),ao(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],o,t=this.el.children,i=0,a=t.length,r=this.options;i<a;i++)o=t[i],U(o,r.draggable,this.el,!1)&&e.push(o.getAttribute(r.dataIdAttr)||fo(o));return e},sort:function(e,o){var t={},i=this.el;this.toArray().forEach(function(a,r){var s=i.children[r];U(s,this.options.draggable,i,!1)&&(t[a]=s)},this),o&&this.captureAnimationState(),e.forEach(function(a){t[a]&&(i.removeChild(t[a]),i.appendChild(t[a]))}),o&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,o){return U(e,o||this.options.draggable,this.el,!1)},option:function(e,o){var t=this.options;if(o===void 0)return t[e];var i=Ye.modifyOption(this,e,o);typeof i<"u"?t[e]=i:t[e]=o,e==="group"&&mn(t)},destroy:function(){H("destroy",this);var e=this.el;e[j]=null,x(e,"mousedown",this._onTapStart),x(e,"touchstart",this._onTapStart),x(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(x(e,"dragover",this),x(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(o){o.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),st.splice(st.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!se){if(H("hideClone",this),y.eventCanceled)return;b(C,"display","none"),this.options.removeCloneOnHide&&C.parentNode&&C.parentNode.removeChild(C),se=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(se){if(H("showClone",this),y.eventCanceled)return;g.parentNode==_&&!this.options.group.revertClone?_.insertBefore(C,g):ge?_.insertBefore(C,ge):_.appendChild(C),this.options.group.revertClone&&this.animate(g,C),b(C,"display",""),se=!1}}};function ao(n){n.dataTransfer&&(n.dataTransfer.dropEffect="move"),n.cancelable&&n.preventDefault()}function Ze(n,e,o,t,i,a,r,s){var l,d=n[j],f=d.options.onMove,c;return window.CustomEvent&&!oe&&!Xe?l=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(l=document.createEvent("Event"),l.initEvent("move",!0,!0)),l.to=e,l.from=n,l.dragged=o,l.draggedRect=t,l.related=i||e,l.relatedRect=a||L(e),l.willInsertAfter=s,l.originalEvent=r,n.dispatchEvent(l),f&&(c=f.call(d,l,r)),c}function vt(n){n.draggable=!1}function ro(){It=!1}function so(n,e,o){var t=L(Se(o.el,0,o.options,!0)),i=fn(o.el,o.options,w),a=10;return e?n.clientX<i.left-a||n.clientY<t.top&&n.clientX<t.right:n.clientY<i.top-a||n.clientY<t.bottom&&n.clientX<t.left}function lo(n,e,o){var t=L(Dt(o.el,o.options.draggable)),i=fn(o.el,o.options,w),a=10;return e?n.clientX>i.right+a||n.clientY>t.bottom&&n.clientX>t.left:n.clientY>i.bottom+a||n.clientX>t.right&&n.clientY>t.top}function co(n,e,o,t,i,a,r,s){var l=t?n.clientY:n.clientX,d=t?o.height:o.width,f=t?o.top:o.left,c=t?o.bottom:o.right,v=!1;if(!r){if(s&&nt<d*i){if(!Fe&&(ze===1?l>f+d*a/2:l<c-d*a/2)&&(Fe=!0),Fe)v=!0;else if(ze===1?l<f+nt:l>c-nt)return-ze}else if(l>f+d*(1-i)/2&&l<c-d*(1-i)/2)return uo(e)}return v=v||r,v&&(l<f+d*a/2||l>c-d*a/2)?l>f+d/2?1:-1:0}function uo(n){return G(g)<G(n)?1:-1}function fo(n){for(var e=n.tagName+n.className+n.src+n.href+n.textContent,o=e.length,t=0;o--;)t+=e.charCodeAt(o);return t.toString(36)}function po(n){lt.length=0;for(var e=n.getElementsByTagName("input"),o=e.length;o--;){var t=e[o];t.checked&&lt.push(t)}}function ot(n){return setTimeout(n,0)}function kt(n){return clearTimeout(n)}ut&&E(document,"touchmove",function(n){(y.active||be)&&n.cancelable&&n.preventDefault()});y.utils={on:E,off:x,css:b,find:ln,is:function(e,o){return!!U(e,o,e,!1)},extend:Un,throttle:dn,closest:U,toggleClass:$,clone:un,index:G,nextTick:ot,cancelNextTick:kt,detectDirection:gn,getChild:Se,expando:j};y.get=function(n){return n[j]};y.mount=function(){for(var n=arguments.length,e=new Array(n),o=0;o<n;o++)e[o]=arguments[o];e[0].constructor===Array&&(e=e[0]),e.forEach(function(t){if(!t.prototype||!t.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(t));t.utils&&(y.utils=K(K({},y.utils),t.utils)),Ye.mount(t)})};y.create=function(n,e){return new y(n,e)};y.version=Yn;var B=[],Ne,_t,Ct=!1,bt,yt,dt,Pe;function go(){function n(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return n.prototype={dragStarted:function(o){var t=o.originalEvent;this.sortable.nativeDraggable?E(document,"dragover",this._handleAutoScroll):this.options.supportPointer?E(document,"pointermove",this._handleFallbackAutoScroll):t.touches?E(document,"touchmove",this._handleFallbackAutoScroll):E(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(o){var t=o.originalEvent;!this.options.dragOverBubble&&!t.rootEl&&this._handleAutoScroll(t)},drop:function(){this.sortable.nativeDraggable?x(document,"dragover",this._handleAutoScroll):(x(document,"pointermove",this._handleFallbackAutoScroll),x(document,"touchmove",this._handleFallbackAutoScroll),x(document,"mousemove",this._handleFallbackAutoScroll)),Gt(),it(),Vn()},nulling:function(){dt=_t=Ne=Ct=Pe=bt=yt=null,B.length=0},_handleFallbackAutoScroll:function(o){this._handleAutoScroll(o,!0)},_handleAutoScroll:function(o,t){var i=this,a=(o.touches?o.touches[0]:o).clientX,r=(o.touches?o.touches[0]:o).clientY,s=document.elementFromPoint(a,r);if(dt=o,t||this.options.forceAutoScrollFallback||Xe||oe||He){wt(o,this.options,s,t);var l=le(s,!0);Ct&&(!Pe||a!==bt||r!==yt)&&(Pe&&Gt(),Pe=setInterval(function(){var d=le(document.elementFromPoint(a,r),!0);d!==l&&(l=d,it()),wt(o,i.options,d,t)},10),bt=a,yt=r)}else{if(!this.options.bubbleScroll||le(s,!0)===J()){it();return}wt(o,this.options,le(s,!1),!1)}}},ne(n,{pluginName:"scroll",initializeByDefault:!0})}function it(){B.forEach(function(n){clearInterval(n.pid)}),B=[]}function Gt(){clearInterval(Pe)}var wt=dn(function(n,e,o,t){if(e.scroll){var i=(n.touches?n.touches[0]:n).clientX,a=(n.touches?n.touches[0]:n).clientY,r=e.scrollSensitivity,s=e.scrollSpeed,l=J(),d=!1,f;_t!==o&&(_t=o,it(),Ne=e.scroll,f=e.scrollFn,Ne===!0&&(Ne=le(o,!0)));var c=0,v=Ne;do{var p=v,m=L(p),h=m.top,k=m.bottom,T=m.left,O=m.right,Y=m.width,z=m.height,de=void 0,V=void 0,ce=p.scrollWidth,Ie=p.scrollHeight,F=b(p),ke=p.scrollLeft,ie=p.scrollTop;p===l?(de=Y<ce&&(F.overflowX==="auto"||F.overflowX==="scroll"||F.overflowX==="visible"),V=z<Ie&&(F.overflowY==="auto"||F.overflowY==="scroll"||F.overflowY==="visible")):(de=Y<ce&&(F.overflowX==="auto"||F.overflowX==="scroll"),V=z<Ie&&(F.overflowY==="auto"||F.overflowY==="scroll"));var _e=de&&(Math.abs(O-i)<=r&&ke+Y<ce)-(Math.abs(T-i)<=r&&!!ke),Z=V&&(Math.abs(k-a)<=r&&ie+z<Ie)-(Math.abs(h-a)<=r&&!!ie);if(!B[c])for(var ue=0;ue<=c;ue++)B[ue]||(B[ue]={});(B[c].vx!=_e||B[c].vy!=Z||B[c].el!==p)&&(B[c].el=p,B[c].vx=_e,B[c].vy=Z,clearInterval(B[c].pid),(_e!=0||Z!=0)&&(d=!0,B[c].pid=setInterval((function(){t&&this.layer===0&&y.active._onTouchMove(dt);var Ce=B[this.layer].vy?B[this.layer].vy*s:0,ae=B[this.layer].vx?B[this.layer].vx*s:0;typeof f=="function"&&f.call(y.dragged.parentNode[j],ae,Ce,n,dt,B[this.layer].el)!=="continue"||cn(B[this.layer].el,ae,Ce)}).bind({layer:c}),24))),c++}while(e.bubbleScroll&&v!==l&&(v=le(v,!1)));Ct=d}},30),bn=function(e){var o=e.originalEvent,t=e.putSortable,i=e.dragEl,a=e.activeSortable,r=e.dispatchSortableEvent,s=e.hideGhostForTarget,l=e.unhideGhostForTarget;if(o){var d=t||a;s();var f=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:o,c=document.elementFromPoint(f.clientX,f.clientY);l(),d&&!d.el.contains(c)&&(r("spill"),this.onSpill({dragEl:i,putSortable:t}))}};function Bt(){}Bt.prototype={startIndex:null,dragStart:function(e){var o=e.oldDraggableIndex;this.startIndex=o},onSpill:function(e){var o=e.dragEl,t=e.putSortable;this.sortable.captureAnimationState(),t&&t.captureAnimationState();var i=Se(this.sortable.el,this.startIndex,this.options);i?this.sortable.el.insertBefore(o,i):this.sortable.el.appendChild(o),this.sortable.animateAll(),t&&t.animateAll()},drop:bn};ne(Bt,{pluginName:"revertOnSpill"});function Lt(){}Lt.prototype={onSpill:function(e){var o=e.dragEl,t=e.putSortable,i=t||this.sortable;i.captureAnimationState(),o.parentNode&&o.parentNode.removeChild(o),i.animateAll()},drop:bn};ne(Lt,{pluginName:"removeOnSpill"});y.mount(new go);y.mount(Lt,Bt);function ct(n){const e=document.getElementById("notes-grid");if(!e)return;e.innerHTML="";const o=u.currentView==="all"?u.notes.filter(r=>{const s=u.categories.find(l=>l.id===r.categoryId);return!s||!s.passwordHash}):u.notes.filter(r=>r.categoryId===u.currentView),t=o.filter(r=>r.pinned),i=o.filter(r=>!r.pinned),a=r=>{const s=document.createElement("div");s.className="note-card note-animate-in relative group",s.dataset.id=r.id;const l=Re.find(v=>v.id===r.themeId)||Re[0],d=u.settings.theme==="dark"?l.dark:l.light;r.themeId!=="default"&&(s.style.backgroundColor=d,s.style.borderColor=u.settings.theme==="dark"?"rgba(255,255,255,0.1)":"rgba(0,0,0,0.05)");const f=u.categories.find(v=>v.id===r.categoryId),c=u.unlockedNotes.has(r.id);return s.innerHTML=`
            <div class="note-card-content">
                <div class="flex items-start justify-between mb-2">
                    <h3 class="font-bold text-sm line-clamp-2 leading-tight flex-1 pr-2">${r.title}</h3>
                    <div class="flex items-center gap-2 shrink-0">
                        ${r.pinned?'<i data-lucide="pin" class="w-3 h-3 fill-current opacity-60"></i>':""}
                        ${r.passwordHash?`<i data-lucide="${c?"unlock":"lock"}" class="w-3.5 h-3.5 lock-indicator cursor-pointer opacity-60 hover:opacity-100 transition-opacity" data-id="${r.id}"></i>`:""}
                        <button class="delete-note-btn p-1 rounded-md hover:bg-destructive/10 hover:text-destructive transition-colors md:opacity-0 md:group-hover:opacity-100 text-muted-foreground/50" data-id="${r.id}" title="Eliminar">
                ...
                <div class="mt-auto pt-2">
                    <span class="text-[9px] px-1.5 py-0.5 rounded bg-muted/50 font-medium text-muted-foreground/70 uppercase tracking-wider">${f.name}</span>
                </div>`:""}
            </div>
        `,s.onclick=async v=>{if(!v.target.closest(".delete-note-btn")){if(r.passwordHash&&!u.unlockedNotes.has(r.id)){try{const p=await te("Nota Protegida","Ingresa la contraseña para ver esta nota:");if(!p)return;if(await N.hashPassword(p)!==r.passwordHash){S("❌ Contraseña incorrecta");return}u.unlockedNotes.add(r.id),n(r),setTimeout(()=>ct(n),300)}catch(p){console.error("Error unlocking note:",p),S("❌ Error al desbloquear")}return}n(r)}},s};if(t.length>0){const r=document.createElement("h3");if(r.className="text-xs font-bold text-muted-foreground uppercase tracking-wider col-span-full mb-2 mt-2 flex items-center gap-2",r.innerHTML='<i data-lucide="pin" class="w-3 h-3"></i> Destacadas',e.appendChild(r),t.forEach(s=>e.appendChild(a(s))),i.length>0){const s=document.createElement("div");s.className="col-span-full h-px bg-border my-4",e.appendChild(s)}}if(i.length>0){if(t.length>0){const r=document.createElement("h3");r.className="text-xs font-bold text-muted-foreground uppercase tracking-wider col-span-full mb-2 mt-2",r.innerText="Notas",e.appendChild(r)}i.forEach(r=>e.appendChild(a(r)))}o.length===0&&(e.innerHTML=`<div class="col-span-full text-center py-20 text-muted-foreground opacity-50">
            <i data-lucide="ghost" class="w-12 h-12 mx-auto mb-4 opacity-50"></i>
            <p>No hay notas aquí</p>
        </div>`),q(),e.querySelectorAll(".delete-note-btn").forEach(r=>{r.onclick=async s=>{s.stopPropagation();const l=r.dataset.id,d=u.notes.find(f=>f.id===l);if(d!=null&&d.passwordHash&&!u.unlockedNotes.has(d.id)){const f=await te("Eliminar Nota Protegida","Ingresa la contraseña para autorizar la eliminación:");if(!f)return;if(await N.hashPassword(f)!==d.passwordHash)return S("❌ Contraseña incorrecta")}confirm("¿Eliminar esta nota?")&&(u.notes=u.notes.filter(f=>f.id!==l),await X(),ct(n),window.triggerAutoSync&&window.triggerAutoSync())}}),mo()}function mo(n){const e=document.getElementById("notes-grid");e&&(e.sortable&&e.sortable.destroy(),e.sortable=y.create(e,{animation:250,ghostClass:"opacity-50",onEnd:async()=>{const o=[];e.querySelectorAll(".note-card").forEach(a=>{const r=u.notes.find(s=>s.id===a.dataset.id);r&&o.push(r)});const t=new Set(o.map(a=>a.id)),i=u.notes.filter(a=>!t.has(a.id));u.notes=[...o,...i],await X()}}))}const ho="974464877836-721dprai6taijtuufmrkh438q68e97sp.apps.googleusercontent.com";let De=null;async function Xt(){console.log("Iniciando aplicación modular..."),localStorage.removeItem("cn_pass_plain_v3"),vo(),In(),wn(),Nn(ee),Fn(),bo(),await Dn(ee),yo(),wo(),Eo(),So(),xo(),ko(),q(),console.log("Aplicación lista.")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xt):Xt();function vo(){const n=document.getElementById("root");if(!n)return console.error("No se encontró el elemento #root");n.innerHTML=`
        ${Tn()}
        ${Ln()}
        ${An()}
        ${Mn()}
